...
$cat_id = $_GET['cat_id'];
  ...
  $sql2 = "select *  from products INNER JOIN categories ON( products.cat_id = categories.cat_id ) INNER JOIN pro_size ON (products.pro_id = pro_size.pro_id)";
...
<nav>
 ...
 <a href="ad_product.php?page=1" aria-label="Previous">
