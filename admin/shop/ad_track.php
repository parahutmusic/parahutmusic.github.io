...
<div class="container top" style="margin-top:-20px;;"> 
    ...
    <p align="center"><font size="3"><b>เพิ่มเลขเช็คพัสดุ</b>
<?php	
...
<div class="col-sm-4">
<form action="ad_track_save.php" method="POST"  class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <div class="col-sm-12">
            <input type="text" name="track_num" id="track_num" class="form-control" required placeholder="เลขเช็คพัสดุ" />
          </div>
        </div>
