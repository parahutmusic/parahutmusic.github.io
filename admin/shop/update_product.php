...
$pro_id 	= $_GET['pro_id'];
	...
	$sql = "select *  from products where products.pro_id = '$pro_id'"; 
	...
	$rs = mysqli_fetch_array($db_query);
		...
		$img = $rs['img'];
?>
<form id="form-img1" method="post" action="update_product_save.php" enctype="multipart/form-data">
	  <div align="left" style="margin-left:20%;">
		<h3> >> แก้ไขสินค้า << </h3> <br>
    <?php
	  $sql1="select * from categories inner join products on(categories.cat_id = products.cat_id) where products.pro_id = '$pro_id'"; 
	...
	?>
    <br><br>
	ชื่อสินค้า : <input class="admin-prh" name="pro_name" align="middle" type="text" size="80" value="<?php echo $pro_name; ?>" style="width:300px; text-align:center;">
	<br><br>
    รายละเอียดสินค้า :<br>
     <textarea class="admin-prh" name="detail" align="middle" cols="60" rows="5"type="text-area" value="<?php echo $detail; ?>" style="width:500px;"><?php echo $detail; ?></textarea>
	<br><br>
    ราคา : <input class="admin-prh" name="price" align="middle" type="text" size="80" value="<?php echo $price ; ?>" style="width:300px; text-align:center;">
	<br><br>
    รูปภาพสินค้า : <input class="admin-prh" name="img" align="middle" type="file"><br>
